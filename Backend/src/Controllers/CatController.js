...
const getProducts = async (req, res) => {
    try{
        const prods = await Catalogue.find();
        return res.status(200).send({ error: false, message: "Done", result: prods });
    }
...
module.exports = { createCatalogue, getCatById, deleteCat, updateCat, getCat, getProducts };